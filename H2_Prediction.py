...
Original file is located at
    https://colab.research.google.com/drive/1tteZr-6lA8LNqKnBEL-ffjljRvJ48IQN
"""
...
data = pd.read_excel("Data-H2.xlsx")
categorical_columns = ["AT", "ST", "CT"]

X = data.drop(columns=["H2"])
y = data["H2"]
...
plt.savefig("h2_R2_RMSE.png", dpi=400, bbox_inches='tight')
...
plt.savefig("h2_MAPE_MAE.png", dpi=400, bbox_inches='tight')
